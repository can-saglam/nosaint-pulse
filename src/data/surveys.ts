...
export const segments: Segment[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        branches: {
          "I’m still deciding which flavour to try": "p3",
          "I’m not sure the device is right for me": "p3",
          "The price feels high for a first try": "p3",
          "I’m planning to order soon": "p3",
        },
      },
      {
        id: "p2b",
        type: "single",
        title: "Which brand are you currently using?",
        options: [
          "Elf Bar",
          "Lost Mary",
          "SKE Crystal",
    ...
    questions: [
      {
        ...
        branches: {
          "Yes, but I ran out and haven’t restocked": "df2",
          "I’ve cut down or stopped": "df2",
          "Still using what I have from my first order": "df2",
        },
      },
      {
        id: "df1b",
        type: "single",
        title: "Which brand have you switched to?",
        options: [
          "Elf Bar",
          "Lost Mary",
          "SKE Crystal",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "dr1b",
        type: "single",
        title: "Which brand did you switch to?",
        options: [
          "Elf Bar",
          "Lost Mary",
          "SKE Crystal",
