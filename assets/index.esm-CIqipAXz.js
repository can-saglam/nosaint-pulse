 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(et(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function et(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const A="@firebase/app",P="0.14.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vt(t){F(new S("platform-logger",e=>new Ze(e),"PRIVATE")),F(new S("heartbeat",e=>new Ht(e),"PRIVATE")),D(A,P,t),D(A,P,"esm2020"),D("fire-js","")}Vt("");export{Gt as A,Ce as B,ne as C,O as D,Qt as E,w as F,tn as G,te as H,ie as I,l as J,Kt as K,Fe as L,Xt as M,qt as N,Yt as O,S as P,on as Q,Jt as R,pn as S,jt as T,ve as U,Se as V,Zt as W,en as X,K as _,hn as a,m as b,un as c,E as d,Bt as e,he as f,dn as g,Tt as h,F as i,fn as j,v as k,$t as l,mn as m,bn as n,Nt as o,gn as p,yn as q,D as r,vn as s,rn as t,sn as u,nn as v,an as w,L as x,cn as y,ln as z};
